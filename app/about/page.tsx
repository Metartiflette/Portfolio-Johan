    ...
    return (
        <main className="relative min-h-screen px-6 md:px-12">
            ...
            <section className="mt-12 md:mt-24">
                ...
                <div className="mt-6 md:mt-12 flex flex-col md:flex-row flex-wrap gap-8 md:gap-12 items-center justify-center">
                    {about.clientsSection.clients?.map((client, index) => (
                        ...
                        >
                            <Image
                                ...
                                width={200}
                                height={120}
                                className="object-contain max-w-[180px] h-auto max-h-[100px] opacity-80 hover:opacity-100 transition-opacity"
                                loading="lazy"
                            />
                        </div>
                    ))}
            ...
            {about.sections?.map((section, index) => (
                ...
                >
                    ...
                    {section.images && section.images.length > 0 && (
                        <div className={`grid gap-6 mb-12 ${section.images.length === 1
